...
import { GIFT_BOX_TYPES, CATALOG_PRODUCTS, SUBCATEGORIES } from '@/utils/constants';
    ...
    <div className="max-w-7xl mx-auto w-full flex flex-col min-h-screen bg-[#F7F6F2] p-4 md:p-8 space-y-6 pb-28 md:pb-16 rounded-none">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[11px] md:text-xs text-[#7A8275] font-medium">{matchedType.subtitle}</p>
        </div>
      </div>
      ...
      {/* Sharp Rectangle Immersive Product Cards (Zero Round Corners) */}
