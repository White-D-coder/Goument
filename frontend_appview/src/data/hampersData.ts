...
export const HAMPERS_CATALOG: HamperData[] = [
  ...
  {
    _id: 'corp_luggage',
    slug: 'corporate-luggage',
    name: 'Luggage',
    subCopy: 'Impact-Resistant Ribbed Cabin Case with 360° spinner wheels.',
    category: 'office-travel-bags',
    categoryLabel: 'Office & Travel Bags',
    inside_items: [
      { item: 'Hard-Shell Cabin Luggage', weight: '1 Piece' },
    ],
    packaging_style: 'Impact-Resistant Ribbed Cabin Case',
    description: 'Impact-Resistant Ribbed Cabin Case engineered for executive travel with TSA lock and smooth spinner wheels.',
    price: 0,
    image: '/images/corporate/OfficeTravelBags/Luggage.jpg',
    highlights: ['TSA Integrated Lock', 'Polycarbonate Shell', '360° Silent Wheels'],
  },
  {
