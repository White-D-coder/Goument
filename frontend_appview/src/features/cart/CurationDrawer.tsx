      ...
      {isDrawerOpen && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          >
            ...
            {/* ── 1. DRAWER HEADER ── */}
            <div className="px-5 py-4 sm:px-6 sm:py-5 border-b border-[#E8E4DC] flex items-center justify-between bg-white/70 backdrop-blur-md">
            ...
            <div className="p-5 sm:p-6 border-t border-[#E8E4DC] bg-white/90 space-y-3">
